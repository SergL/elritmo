...
require_once( 'classes/class-wootickets.php' );
require_once( 'vendor/tribe-common-libraries/tribe-common-libraries.class.php' );
require_once( 'classes/tribe-events-wootickets-pue.class.php' );
...
function tribe_wootickets_show_fail_message() {
	...
	if ( is_incompatible_events_core_installed() ) {
		printf( __( 'To begin using WooTickets, please install the latest version of <a href="%s" class="thickbox" title="%s">%s</a>.', 'tribe-wootickets' ), esc_url( $url_tec ), $title_tec, $title_tec );
	} elseif ( is_incompatible_woocommerce_installed() ) {
		printf( __( 'To begin using WooTickets, please install the latest version of <a href="%s" class="thickbox" title="%s">%s</a>.', 'tribe-wootickets' ), esc_url( $url_woocommerce ), $title_woocommerce, $title_woocommerce );
	}
