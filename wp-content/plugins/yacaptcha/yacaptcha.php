...
$yaCaptchaCharInputMsg = 'Введите символы, которые показаны на картинке';
...
function yaCaptchaCommentFormAfterFields() {
    ...
    if ('' == $userdata->ID) {
        ...
        <p class="comment-form-captcha">
			...
			<input id="captcha" name="captcha" type="text" value="" size="22" aria-required="true" />
            <label for="captcha"><small><?php echo __($yaCaptchaCharInputMsg); ?> <font color='red'>*</font></small></label>            
        </p>
        <?php
    }
}
