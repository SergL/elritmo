...
if (!class_exists('TribeEventsFilterView')) {
	class TribeEventsFilterView {
		...
		public function initialize_filters() {
			...
			new TribeEventsFilter_Venue( __( 'Venues', 'tribe-events-filter-view' ), 'venues' );
			new TribeEventsFilter_Organizer( __( 'Organizers', 'tribe-events-filter-view' ), 'organizers' );
