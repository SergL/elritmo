	...
	class MFN_Options{
		...
		*/
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['menu_title'] = __('Theme Options | Kora', 'mfn-opts');
					...
					echo '<div id="mfn-main">';
						echo '<div class="mfn-header">';
							echo '<div class="mfn-buttons">';
								...
								echo '<a class="mfn-btn-doc" href="http://themes.muffingroup.com/kora/documentation.pdf" target="_blank"><span>Documentation</span></a>';
							echo '</div>';
